...
Below is an image of the four temperature sensors that were plotting. one of the sensors was broken when it arrived, giving the value of 0 for the top line with the blue triangles as shown.
